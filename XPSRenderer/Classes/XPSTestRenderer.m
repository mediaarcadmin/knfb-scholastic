...
@implementation XPSTestRenderer

@synthesize imageInfo, tempDirectory, xpsData, componentCache, xpsPath, pageCount, pageCropsCache, viewTransformsCache;// bookIsEncrypted, uriMap, xpsPagesDirectory;

void XPSPageCompleteCallback(void *userdata, RasterImageInfo *data) {
	XPSTestRenderer *provider = (XPSTestRenderer *)userdata;	
...
- (UIImage *)coverThumbForList {
    ...
    NSData *imageData = [self dataFromXPSAtPath:pixelSpecificKey];
