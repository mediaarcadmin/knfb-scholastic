...
NSString * const kSCHLibreAccessWebServiceListUserContentEx = @"ListUserContentEx";
...
NSString * const kSCHLibreAccessWebServiceUserContentListEx = @"UserContentListEx";
