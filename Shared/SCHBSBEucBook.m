...
{
    NSString *nodeBlockOverride = @"node { display: block; } select { display: block; page-break-before: avoid; } input { page-break-before: avoid; page-break-inside: avoid; } *[visible-if=\"Gender = 'boy'\"] { display: none } body { line-height: 140%; }";
