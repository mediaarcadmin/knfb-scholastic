...
static NSString * const kSCHLibreAccessWebServiceLocationGraphicsPage = @"LocationGraphics.Page";
static NSString * const kSCHLibreAccessWebServiceLocationTextPage = @"LocationText.Page";
