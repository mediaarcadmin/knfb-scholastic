...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.Exception != 0) {
		...
		if([@"GetUserInfoSvc" length] > 0) {
			newnode = xmlNewDocNode(node->doc, NULL, [@"GetUserInfoSvc:Exception" xmlString], NULL);        
		} else {
			newnode = xmlNewDocNode(node->doc, NULL, [@"Exception" xmlString], NULL);        
		}
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.desc != 0) {
		...
		xmlNodePtr newnode;
		if([@"ax25" length] > 0) {
			newnode = xmlNewDocNode(node->doc, NULL, [@"ax25:desc" xmlString], NULL);        
		} else {
			newnode = xmlNewDocNode(node->doc, NULL, [@"desc" xmlString], NULL);        
		}
        xmlNewProp(newnode, (const xmlChar *)"xsi:nil", (const xmlChar *)"true");
        xmlAddChild(node, newnode);
	}
	if(self.id_ != 0) {
		...
		xmlNodePtr newnode;
		if([@"ax25" length] > 0) {
			newnode = xmlNewDocNode(node->doc, NULL, [@"ax25:id" xmlString], NULL);        
		} else {
			newnode = xmlNewDocNode(node->doc, NULL, [@"id" xmlString], NULL);        
		}
        xmlNewProp(newnode, (const xmlChar *)"xsi:nil", (const xmlChar *)"true");
        xmlAddChild(node, newnode);
	}
	if(self.message != 0) {
		...
		xmlNodePtr newnode;
		if([@"ax25" length] > 0) {
			newnode = xmlNewDocNode(node->doc, NULL, [@"ax25:message" xmlString], NULL);        
		} else {
			newnode = xmlNewDocNode(node->doc, NULL, [@"message" xmlString], NULL);        
		}
        xmlNewProp(newnode, (const xmlChar *)"xsi:nil", (const xmlChar *)"true");
        xmlAddChild(node, newnode);
	}
