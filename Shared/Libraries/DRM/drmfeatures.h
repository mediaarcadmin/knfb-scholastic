...
/* AC:  */
#define DRM_BUILD_PROFILE				10 /* or put in project settings */
#define TARGET_LITTLE_ENDIAN			1 /* fixes error in drmcopiler.h */
#define DRM_SUPPORT_TRACING				0  /* fixes simulator link error with Blio */
