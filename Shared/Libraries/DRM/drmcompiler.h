...
#define SIXTEEN_BIT_ADDRESSING  0
#define DRM_CALL
#define DRMINLINE               static /*was inline; caused "symbol(s) not found" link errors, whether DRM_INLINING_SUPPORTED on or not */
										/* evidently because compiler did not want to inline, under any optimization level */
										/* "static" -> no inlining, and without causing duplicate-symbol errors */
#define DRMFORCEINLINE          static /* was inline; see above */
#define DRM_EXTERN_INLINE       extern /*inline*/ /*inline was DRMINLINE, and "extern static" not legal*/
#define DRM_EXPORTED_INLINE     DRMINLINE
#define DRM_INLINING_SUPPORTED  1  
#define DRM_DWORD_ALIGN         DRM_ALIGN_4
#define DRM_NO_INLINE			
...
/* ============================================================================ */
#elif defined (__GNUC__)
/*AC:*/                                                   /* 8-bit addressing    16 bit addressing*/
typedef unsigned char /*int8_t*/         DRM_BYTE;               /* 1 byte              1 byte */
typedef char /*int8_t*/                  DRM_CHAR;               /* 1 byte              1 byte */
typedef unsigned short /*int16_t*/        DRM_WORD;               /* 2 bytes             1 byte */
typedef short /*int16_t*/                 DRM_SHORT;              /* 2 bytes             1 byte */
typedef unsigned short /*int16_t*/        DRM_WCHAR;              /* 2 bytes             1 byte */
typedef int /*int32_t*/                 DRM_BOOL;               /* 4 bytes             2 bytes */
typedef unsigned int /*int32_t*/        DRM_DWORD;              /* 4 bytes             2 bytes */
typedef unsigned int /*int32_t*/        DRM_WCHAR32;            /* 4 bytes             2 bytes */
typedef int /*int32_t*/                 DRM_LONG;               /* 4 bytes             2 bytes */
typedef unsigned int /*int32_t*/        DRM_UINT;               /* 4 bytes             2 bytes */
typedef int /*int32_t*/                 DRM_INT;                /* 4 bytes             2 bytes */
...
//typedef int int32_                 DRM_LONG;               /* 4 bytes             2 bytes */
...
typedef wchar_t                 DRM_WCHAR_NATIVE;      /* 2 bytes             1 byte */
#else
typedef unsigned short /*int16_t*/        DRM_WCHAR_NATIVE;      /* 2 bytes             1 byte */
#endif
